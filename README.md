...
```
A tab-delimited file (`promoter_delineations.tsv`) with promoter delineation points in terms of distance from the TSS (columns 1 (start) and 2 (end)) expected as output. 1 hr. runtime expected.
## Instructions for use
